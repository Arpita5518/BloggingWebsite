...
<html lang="en">
 <head>
   ...
   <title>Inno Blogging site</title>
                ...
                <div class="col-lg-12">
                  ...
                  <div class="blog-post">
                    <div class="blog-thumb">
                        <img src="<%=blog.getImage()%>" alt="" style="width:100%;height: 150px;">
                    </div>
                    <div class="down-content">
                      <a href="#"><h4><%=blog.getTitle()%></h4></a>
                      <ul class="post-info">
                          <li><a href="#"><% Blogger blogger =  new BloggerDao().find(blog.getBloggerId()); out.println(blogger.getName()); %></a></li>
                        <li><a href="#"><%=blog.getDate()%></a></li>
                        <li><a href="#">12 Comments</a></li>
                      </ul>
                      <p style="text-align:justify"><%=blog.getDescription().substring(0,250)%>... </p>
                        <div class="row">
                          <div class="col-12">
