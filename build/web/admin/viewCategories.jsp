...
<%@page contentType="text/html" pageEncoding="UTF-8" import ="gist.beans.Admin,gist.daos.AdminDao"%>
<%
...
<body>
                    ...
                    <div class="col col-md-12">
                        <form  method="post">
                            <table class="table table-bordered">
                             ...
                             <tr>
                                 <td colspan="2"><input type="submit" name="submit" value="Add Category" class="btn btn-primary form-control" required/></td>
                                </tr>
                    ...
                    <div class="col col-md-12">
                        ...
                        <table class="table table-striped">
                            ...
                            <%
                               ...
                               ArrayList<Category> catlist = cdd.findAll();
    ...
    <%
        ...
        <jsp:useBean class="gist.beans.Category" id="category"></jsp:useBean>
